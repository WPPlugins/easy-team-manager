	...
	require_once(ABSPATH . 'wp-admin/includes/image.php');
		...
		global $wpdb;
			$wpdb->update(
				...
				array('name'=> serialize($ind_name_detail),'image'=>$imgpath,'ind_description'=>$ind_desc,'position'=>$ind_position,'url'=>$ind_url, 'email'=>serialize($ind_email_detail),'phone'=>serialize($ind_phone_detail),'social_media'=> serialize($ind_social_media),'team_id'=>$ind_team_id),array( 'id' => $id ), //data
			...
			$wpdb->update(
				''.$wpdb->prefix.'easy_team_manager_description', //table
				array('name'=> serialize($ind_name_detail),'ind_description'=>$ind_desc,'position'=>$ind_position,'url'=>$ind_url,'email'=>serialize($ind_email_detail),'phone'=>serialize($ind_phone_detail),'social_media'=> serialize($ind_social_media),'team_id'=>$ind_team_id),
				array( 'id' => $id ), //data
